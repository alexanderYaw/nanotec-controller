...
namespace NanotecController
{
    ...
    public partial class FrmMain
    {
        ...
        public bool CanAccessParams => _connection.IsConnected && !_busy;

        /// <summary>Writing/saving needs the link up, idle, and the axis map present.</summary>
        public bool CanWriteParams => _connection.IsConnected && !_busy && _motion != null;
        ...
        /// </summary>
        public async Task ReadAllParamsAsync(IProgress<string> sink)
        {
        ...
        /// </summary>
        public async Task WriteObjectAsync(AxisId id, ushort index, byte sub, long value, uint bits, IProgress<string> sink)
        {
        ...
        public async Task SaveParamsToNvAsync(AxisId id, IProgress<string> sink)
        {
